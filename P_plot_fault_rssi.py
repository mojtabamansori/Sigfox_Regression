...
X_Train1 = X_Train[index_1]
X_Train2 = X_Train[index_2]
X_Train3 = X_Train[index_3]

Y_Train_1 = Y_Train[index_1]
Y_Train_2 = Y_Train[index_2]
Y_Train_3 = Y_Train[index_3]
...
for i_row in range(len(X_test_combined)):
    print(i_row / len(X_test_combined))
    for i_col in range(137):
        x_test_cur = X_test_combined[i_row, i_col]

        if x_test_cur == -200:
            for i_list1 in list_1:
                if i_list1 == i_col:
                    sum_1 = sum_1 + 1
            for i_list2 in list_2:
                if i_list2 == i_col:
                    sum_2 = sum_2 + 1
            for i_list3 in list_3:
                if i_list3 == i_col:
                    sum_3 = sum_3 + 1
