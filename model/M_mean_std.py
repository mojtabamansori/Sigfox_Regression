...
def list_change_section(lists_old, number_section_old):
    ...
    return lists_old, (number_section_old-1)
...
for i in range(18):
    lists, numebers_section = list_change_section(lists, numebers_section)
