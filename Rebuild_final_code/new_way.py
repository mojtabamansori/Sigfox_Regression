...
for number_section_old in range(4, 5):
    for number_seed_1 in range(42, 43):
        ...
        flag = 0
        for i_temp in list_gateway_mearge:
            if flag == 0:
                flag +=1
        ...
        #
        #     index = index_section(numbers_section, Y_train_combined, i_model, index, section_list)
